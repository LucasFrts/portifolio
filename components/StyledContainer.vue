...
.adjusted-text {
    ...
    /* Define o texto para ser exibido verticalmente da direita para a esquerda */
}

.adjusted-text div {
    display: inline-block;
    /* Garante que cada letra fique em uma linha separada */
}

.adjusted-text div::after {
    content: attr(data-letter);
    /* Mostra o texto original de cada letra */
    display: block;
    transform: rotate(-90deg);
    /* Rotaciona cada letra em -90 graus */
